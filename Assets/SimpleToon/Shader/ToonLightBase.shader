Shader "Lpk/LightModel/ToonLightBase"
{
    Properties
    {
        ...
        _Emission            ("EmissiveMap", 2D)                       = "black" {}
        [HDR]_EmissionColor          ("Emissive Color", Color)                      = (0.5,0.5,0.5,1)
            ...
            float4 frag(Varyings input) : SV_Target
{
    ...
    float4 emissiveMap = SAMPLE_TEXTURE2D(_Emission, sampler_Emission, uv);
    ...
    // Emission (Additive)
    float3 emission = emissiveMap.rgb * _EmissionColor;
